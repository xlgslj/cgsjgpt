...
function init() {
    ...
    jQuery.ajax({
        ...
        url: "/api/SysQxRole/RolesEditIndex",
        headers: {
        ...
        success: function (res) {
            ...
            data.role = res.role;
            data.role.IDS = JSON.parse(data.role.IDS);
            ...
            one.forEach(function (item) {
                ...
                two.forEach(function (item2) {
                    ...
                    three.forEach(function (item3) {
                        let v = data.role.IDS.find(function (item4) {
                            return item4 == item3.ID;
                        });
                        item3.CK = v == undefined ? false : true;
