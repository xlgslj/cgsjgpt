...
namespace cgsjgpt.userclass.method
{
    ...
    public sealed class SecurityHelper
    {
        ...
        private static byte[] HashEncrypt_b(HashAlgorithm hashAlgorithm, string input, Encoding encoding)
        {
        ...
        public static byte[] HMACSHA1Encrypt_b(string input, string key, Encoding encoding)
        {
            return HashEncrypt_b(new HMACSHA1(encoding.GetBytes(key)), input, encoding);
        }
