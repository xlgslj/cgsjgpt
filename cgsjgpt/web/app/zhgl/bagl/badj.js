...
function init() {
    ...
    jQuery.ajax({
        ...
        success: function (res) {
            layer.close(index);
            data.db = res.data;
            data.db.IMG1 = "组织机构代码证";
            data.db.IMG2 = "委托书";
            data.db.URL1 = "/web/images/zwtp.png";
            data.db.URL2 = "/web/images/zwtp.png";
            data.db.URL3 = "/web/images/zwtp.png";
            data.db.URL4 = "/web/images/zwtp.png";
            data.db.URL5 = "/web/images/zwtp.png";
            data.db.URL6 = "/web/images/zwtp.png";
